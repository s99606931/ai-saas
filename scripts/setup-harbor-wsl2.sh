...
# C-01 수정: 기본값 Harbor12345 제거 — 배포 전 HARBOR_ADMIN_PASSWORD 환경변수 필수 설정
# export HARBOR_ADMIN_PASSWORD=$(openssl rand -hex 16)
HARBOR_ADMIN_PASSWORD="${HARBOR_ADMIN_PASSWORD:?오류: HARBOR_ADMIN_PASSWORD 환경변수를 설정하세요. 예: export HARBOR_ADMIN_PASSWORD=\$(openssl rand -hex 16)}"
