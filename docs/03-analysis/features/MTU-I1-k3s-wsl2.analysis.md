...
| **SCOPE** | `docs/framework/05-infra/` 3개 파일 |
...
|-------------|---------|------|------|
| `05-infra/k3s-wsl2/cluster-setup-recipe.md` | `docs/framework/05-infra/k3s-wsl2/cluster-setup-recipe.md` | O | 5개 섹션 + FAQ 포함 |
| `05-infra/k3s-wsl2/scripts/install-k3s.sh` | `docs/framework/05-infra/k3s-wsl2/scripts/install-k3s.sh` | O | 6단계 자동화 스크립트 |
| `05-infra/container-security-baseline.md` | `docs/framework/05-infra/container-security-baseline.md` | O | CSAP-D11 7항목 체크리스트 |
