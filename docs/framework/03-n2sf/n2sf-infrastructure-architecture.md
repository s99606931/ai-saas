...
| 통제 항목 | k3s 구현 | 구현 파일 | CSAP 매핑 |
|---------|---------|---------|---------|
| C등급 완전 격리 | NetworkPolicy + 네임스페이스 분리 | [network-policy-guide.md](../07-infra/network-policy-guide.md) | CSAP-D10-01 |
| S등급 접근 통제 | NetworkPolicy Ingress/Egress 제한 | [grade-s-restricted.yaml](../07-infra/network-policies/grade-s-restricted.yaml) | CSAP-D10-02 |
| 등급 간 통신 통제 | 명시적 허용 목록 (화이트리스트) | [network-policy-guide.md](../07-infra/network-policy-guide.md) | CSAP-D10-03 |
| 네트워크 감사 | OTel k8sobjects + audit.jsonl | [opentelemetry-guide.md](../07-infra/opentelemetry-guide.md) | CSAP-D06-01 |
...
| 키 수명 주기 | Cosign 키 연간 교체 | [sigstore-signing.md](../07-infra/supply-chain/sigstore-signing.md) | CSAP-D09-03 |
| 이미지 무결성 | Cosign 서명 + Harbor 정책 | [harbor-registry-guide.md](../07-infra/harbor-registry-guide.md) | CSAP-D12-02 |
...
| C/S 등급 AI 전송 차단 | NetworkPolicy + 코드 검증 | [network-policy-guide.md](../07-infra/network-policy-guide.md) | N2SF-N05 |
...
- [k3s 클러스터 설치 레시피](../07-infra/k3s-wsl2/) — MTU-I1
- [Gitea CI/CD 파이프라인](../07-infra/gitea-cicd-guide.md) — MTU-I2
- [Flux GitOps 가이드](../07-infra/flux-gitops-guide.md) — MTU-I3
- [Harbor 레지스트리](../07-infra/harbor-registry-guide.md) — MTU-I3
- [NetworkPolicy 가이드](../07-infra/network-policy-guide.md) — MTU-I4
- [OpenTelemetry 가이드](../07-infra/opentelemetry-guide.md) — MTU-I4
