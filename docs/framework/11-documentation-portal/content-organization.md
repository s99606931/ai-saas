...
const ctoSidebar = [
  ...
  { type: 'category', label: '감리 현황', items: [
    '06-audit-compliance/audit-completion-checklist',
    '06-audit-compliance/templates/T04-traceability-matrix',
  ]},
  { type: 'category', label: 'CSAP 준수 현황', items: [
    '02-csap/standard-grade/checklist-master',
  ]},
  { type: 'category', label: 'ISMS-P 준수 현황', items: [
    '04-isms-p/management-controls/M01-M04-policy-org',
  ]},
]
```
...
const devSidebar = [
  ...
  { type: 'category', label: 'AI 연동', items: [
    '08-ai-integration/security-gateway-pattern',
    '08-ai-integration/data-classification-masking',
    '08-ai-integration/mcp-integration-guide',
    '08-ai-integration/lmstudio-guide',
  ]},
  { type: 'category', label: '인프라', items: [
    '07-infra/k3s-wsl2/cluster-setup-recipe',
    '07-infra/gitea-cicd-guide',
    '07-infra/flux-gitops-guide',
    '07-infra/harbor-registry-guide',
  ]},
]
```
...
const auditorSidebar = [
  { type: 'category', label: '감리 산출물', items: [
    '06-audit-compliance/templates/T01-business-plan',
    '06-audit-compliance/templates/T02-requirements',
    '06-audit-compliance/templates/T03-detailed-design',
    '06-audit-compliance/templates/T04-traceability-matrix',
    '06-audit-compliance/templates/T05-test-plan',
    '06-audit-compliance/templates/T06-test-result',
    '06-audit-compliance/templates/T07-defect-management',
  ]},
  { type: 'doc', id: '06-audit-compliance/audit-completion-checklist', label: '감리 완료 체크리스트' },
...
const securitySidebar = [
  ...
  { type: 'category', label: 'N2SF', items: [
    '03-n2sf/data-grade-classification',
    '03-n2sf/csap-n2sf-mapping',
    { type: 'category', label: 'N2SF 영역별', items: [
      '03-n2sf/domains/N01-management-security',
      '03-n2sf/domains/N02-authentication',
      '03-n2sf/domains/N03-isolation',
      '03-n2sf/domains/N04-encryption',
      '03-n2sf/domains/N05-data',
      '03-n2sf/domains/N06-operations',
    ]},
  ]},
  { type: 'category', label: 'ISMS-P', items: [
    { type: 'category', label: '관리체계', items: [
      '04-isms-p/management-controls/M01-M04-policy-org',
      '04-isms-p/management-controls/M05-M08-risk',
      '04-isms-p/management-controls/M09-M12-operation',
      '04-isms-p/management-controls/M13-M16-improvement',
    ]},
    { type: 'category', label: '보호대책', items: [
      '04-isms-p/protection-controls/P01-P14-access',
      '04-isms-p/protection-controls/P15-P29-crypto',
      '04-isms-p/protection-controls/P30-P44-network',
      '04-isms-p/protection-controls/P45-P64-operation',
    ]},
    { type: 'category', label: '개인정보', items: [
      '04-isms-p/privacy-controls/I01-I07-collection',
      '04-isms-p/privacy-controls/I08-I14-processing',
      '04-isms-p/privacy-controls/I15-I21-disposal',
    ]},
  ]},
