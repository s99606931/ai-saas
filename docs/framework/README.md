...
│   └── T02-requirements.md
│
├── 06-audit-compliance/         ← 감리 T01~T07 (제출용 완성 템플릿)
...
│
├── 11-documentation-portal/    ← 문서 포털 (Docusaurus)
...
| **감리 담당자** | 감리 산출물 T01~T07 준비 | [`06-audit-compliance/templates/T01-business-plan.md`](06-audit-compliance/templates/T01-business-plan.md) |
...
**모든 감리 산출물 위치**: [`06-audit-compliance/templates/`](06-audit-compliance/templates/)
...
| 감리 산출물 T01~T07 | `06-audit-compliance/templates/T01~T07.md` |

### N2SF 준수

| 단계 | 문서 |
|------|------|
| 데이터 C/S/O 등급 분류 | `03-n2sf/data-grade-classification.md` |
| CSAP-N2SF 매핑 | `03-n2sf/csap-n2sf-mapping.md` |
| 6개 영역 통제 가이드 | `03-n2sf/domains/N01~N06.md` |
| AI API 보안 게이트웨이 | `08-ai-integration/security-gateway-pattern.md` |

### ISMS-P 2027 의무화 대비

| 단계 | 문서 |
|------|------|
| 취득 타임라인 | `04-isms-p/certification-guide.md` |
| CSAP+ISMS-P 이중 인증 절차 | `04-isms-p/dual-certification-procedure.md` |
| 관리체계 16항목 | `04-isms-p/management-controls/M01~M16.md` |
| 보호대책 64항목 | `04-isms-p/protection-controls/P01~P64.md` |
| 개인정보보호 21항목 | `04-isms-p/privacy-controls/I01~I21.md` |
| 증적 자동화 | `04-isms-p/auto-evidence-collection.md` |
...
| `03-n2sf/` | 9 | 완료 | 6개 영역 전수 수록 |
| `04-isms-p/` | 13 | 진행 중 | 이중 인증 절차 완비 |
| `05-audit-docs/` | 2 | 완료 | 참조본 |
| `06-audit-compliance/` | 8 | 진행 중 | 템플릿 완비, 실제 내용 입력 필요 |
| `07-infra/` | 20 | 완료 | |
| `08-ai-integration/` | 5 | 완료 | |
| `09-cc-harness/` | 1 | 완료 | |
| `10-multitenancy/` | 3 | 진행 중 | |
| `11-documentation-portal/` | 2 | 진행 중 | |
| `12-compliance-dashboard/` | 2 | 미착수 | |
