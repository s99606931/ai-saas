    ...
    steps:
      - name: 증적 파일 수집
        run: |
          ...
          cp docs/framework/07-isms-p/management-controls/*.md audit-package/
          
          # 2. 보호대책 문서 (MTU-C6b)
          cp docs/framework/07-isms-p/protection-controls/*.md audit-package/
          
          # 3. 개인정보 문서 (MTU-C6b)
          cp docs/framework/07-isms-p/privacy-controls/*.md audit-package/
