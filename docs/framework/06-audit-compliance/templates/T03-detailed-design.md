...
> **참조**: [N2SF 인프라 아키텍처](../../03-n2sf/n2sf-infrastructure-architecture.md) §2
...
> **참조**: [Flux GitOps 가이드](../../07-infra/flux-gitops-guide.md) §6
...
> **참조**: [N2SF 인프라 아키텍처](../../03-n2sf/n2sf-infrastructure-architecture.md) §4
