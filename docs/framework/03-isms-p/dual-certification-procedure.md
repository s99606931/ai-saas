...
for doc in M01-M04 M05-M08 M09-M12 M13-M16; do
  if [ -f "docs/framework/03-isms-p/management-controls/${doc}*.md" ]; then
...
for doc in P01-P14 P15-P29 P30-P44 P45-P64; do
  if [ -f "docs/framework/03-isms-p/protection-controls/${doc}*.md" ]; then
...
for doc in I01-I07 I08-I14 I15-I21; do
  if [ -f "docs/framework/03-isms-p/privacy-controls/${doc}*.md" ]; then
