# MTU-N340-capacity-forecast-engine: 용량 예측 엔진 — Design
...
**선택**: 단일 lib 모듈 `platform/services/ai-service/src/lib/capacity-forecast-engine.ts`
...
| FR | CSAP |
|----|------|
| FR-N340.1~6 | D-06/D-08/D-12 |

## 추적성 매트릭스

| FR ID | 구현 | 테스트 |
|-------|------|--------|
| FR-N340.1~6 | capacity-forecast-engine.ts | TC-N340.* |
