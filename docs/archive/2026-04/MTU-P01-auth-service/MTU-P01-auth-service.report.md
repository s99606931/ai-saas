...
| **보안** | CSAP D-08 12항목 | MUST 10항목 100%, SHOULD 2항목 미구현 (MFA/OAuth2) |
...
| FR-P01.10 | MFA TOTP 스켈레톤 | DEFER (SHOULD, Phase P5) |
...
| 12 | 라우트 등록 | `platform/services/auth-service/src/routes.ts` | 완료 |
| 13 | 서비스 진입점 | `platform/services/auth-service/src/index.ts` | 완료 |
| 14 | Dockerfile | `platform/services/auth-service/Dockerfile` | 완료 |
| 15 | package.json | `platform/services/auth-service/package.json` | 완료 |
...
| D-08-08 | MFA | loginSchema mfaCode 필드 준비 | DEFER |
...
| 항목 | 담당 MTU | 시기 |
|------|---------|------|
| MFA TOTP 핸들러 구현 | Phase P5 | 관리자 포털 연동 시 |
