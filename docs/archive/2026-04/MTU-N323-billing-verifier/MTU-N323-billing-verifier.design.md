# MTU-N323-billing-verifier: 과금 검증 — Design
...
**선택**: B. `platform/services/ai-service/src/lib/billing-verifier.ts`
...
| FR | 기능 | CSAP |
|----|------|------|
| FR-N323.1~6 | Plan FR 구현 | D-06/D-08/D-12 |
...
|-------|-----------|------|--------|
| FR-N323.1~6 | §모듈설계 | billing-verifier.ts | TC-N323.* |

## Session Guide

1. lib/billing-verifier.ts 확인 (기구현)
2. __tests__/billing-verifier.test.ts 작성
3. vitest 통과
4. Design Ref 주석 포함

## Design Anchor

- Module: `platform/services/ai-service/src/lib/billing-verifier.ts`
- Test: `platform/services/ai-service/src/lib/__tests__/billing-verifier.test.ts`
