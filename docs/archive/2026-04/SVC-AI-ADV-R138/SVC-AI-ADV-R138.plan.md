# SVC-AI-ADV-R138 — AI 기반 서비스 메시 최적화
...
- `platform/services/ai-service/src/lib/service-mesh-optimizer.ts`
- `platform/services/ai-service/src/lib/__tests__/service-mesh-optimizer.test.ts`
