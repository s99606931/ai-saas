# MTU-N492 Design — R11 플랫폼 완성도 모듈
...
- SCOPE: platform-completion-n492.ts 단일 클래스
...
| FR | 메서드 | 테스트 |
|----|-------|--------|
| FR-N492.1 | initialize() | 초기화 테스트 |
| FR-N492.2 | runSmokeTest() | 스모크 테스트 |
| FR-N492.3 | record() | 감사 로그 테스트 |
