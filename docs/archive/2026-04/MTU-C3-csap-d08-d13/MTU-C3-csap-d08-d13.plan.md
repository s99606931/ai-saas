...
→ 상세 정책 구성: [`08-infra/policy-as-code/kyverno-policies.md`](../../08-infra/policy-as-code/kyverno-policies.md) (MTU-C7)
...
→ 상세 구성: [`08-infra/supply-chain/sigstore-signing.md`](../../08-infra/supply-chain/sigstore-signing.md) (MTU-C8)
