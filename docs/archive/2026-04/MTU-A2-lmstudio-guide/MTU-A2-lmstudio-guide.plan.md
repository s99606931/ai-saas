...
| 파일 | 문서 유형 | 핵심 내용 |
|------|---------|---------|
| `09-ai-integration/lmstudio-guide.md` | 아키텍처 레퍼런스형 | LM Studio 설치·설정·모델 로드 + WSL2 접근 패턴 |
| `09-ai-integration/lmstudio-client-examples.md` | 구현 가이드형 | Python/TypeScript 클라이언트 코드 예시 |
