# MTU-N350-password-policy-enforcer: 비밀번호 정책 집행 — Design
...
**선택**: 단일 lib 모듈 `platform/services/ai-service/src/lib/password-policy-enforcer.ts`
...
| FR | CSAP |
|----|------|
| FR-N350.1~6 | D-06/D-08/D-12 |

## 추적성 매트릭스

| FR ID | 구현 | 테스트 |
|-------|------|--------|
| FR-N350.1~6 | password-policy-enforcer.ts | TC-N350.* |
