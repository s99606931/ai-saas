...
| 관점 | 달성 |
|------|------|
| 비즈니스 | 민원 챗봇 엔진 모듈 구현 완료 |
| 기술 | platform/services/ai-service/src/lib/citizen-chatbot-engine.ts (단일 모듈) |
...
| 단계 | 결정 |
|------|------|
| Plan | MTU-N313 FR-* 정의 (Plan 문서 참조) |
...
- Plan: MTU-N313-citizen-chatbot-engine.plan.md
- Design: MTU-N313-citizen-chatbot-engine.design.md
- 구현: platform/services/ai-service/src/lib/citizen-chatbot-engine.ts
- 테스트: platform/services/ai-service/src/lib/__tests__/citizen-chatbot-engine.test.ts
- Report: MTU-N313-citizen-chatbot-engine.report.md
