...
| 관점 | 달성 |
|------|------|
| 비즈니스 | 행정문서 번역 모듈 구현 완료 |
| 기술 | platform/services/ai-service/src/lib/admin-doc-translator.ts (단일 모듈) |
...
| 단계 | 결정 |
|------|------|
| Plan | MTU-N312 FR-* 정의 (Plan 문서 참조) |
...
- Plan: MTU-N312-admin-doc-translator.plan.md
- Design: MTU-N312-admin-doc-translator.design.md
- 구현: platform/services/ai-service/src/lib/admin-doc-translator.ts
- 테스트: platform/services/ai-service/src/lib/__tests__/admin-doc-translator.test.ts
- Report: MTU-N312-admin-doc-translator.report.md
