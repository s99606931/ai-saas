...
### 모듈 구조
```
platform/services/ai-service/src/lib/release-notes-ai.ts
platform/services/ai-service/src/lib/__tests__/release-notes-ai.test.ts
```
...
| FR | 메서드 | 테스트 |
|----|-------|--------|
| FR-RN.1~5 | release-notes-ai 클래스 메서드 | 5/5 단위 테스트 |
