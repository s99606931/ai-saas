...
### 모듈 구조
```
platform/services/ai-service/src/lib/ransomware-ai.ts
platform/services/ai-service/src/lib/__tests__/ransomware-ai.test.ts
```
...
| FR | 메서드 | 테스트 |
|----|-------|--------|
| FR-RW.1~5 | ransomware-ai 클래스 메서드 | 5/5 단위 테스트 |
