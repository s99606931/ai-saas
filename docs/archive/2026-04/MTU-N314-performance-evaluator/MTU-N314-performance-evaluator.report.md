...
|------|------|
| 비즈니스 | 성능 평가 모듈 구현 완료 |
| 기술 | platform/services/ai-service/src/lib/performance-evaluator.ts (단일 모듈) |
...
| 단계 | 결정 |
|------|------|
| Plan | MTU-N314 FR-* 정의 (Plan 문서 참조) |
...
- Plan: MTU-N314-performance-evaluator.plan.md
- Design: MTU-N314-performance-evaluator.design.md
- 구현: platform/services/ai-service/src/lib/performance-evaluator.ts
- 테스트: platform/services/ai-service/src/lib/__tests__/performance-evaluator.test.ts
- Report: MTU-N314-performance-evaluator.report.md
